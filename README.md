...
Sau khi có URL kho GitHub, thay `REPLACE_WITH_REPOSITORY_URL` trong `thesis/latex/Chuong/7_Phu_luc.tex` bằng phần `owner/repository` tương ứng rồi biên dịch lại đồ án.
